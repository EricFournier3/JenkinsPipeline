...
base_dir="/home/foueri01@inspq.qc.ca/temp/TEMP2/TEST_CENTRIFUGE/"
...
for spec in ${spec_arr[@]}
	...
	centrifuge_cmd="centrifuge -x ${CENTRIFUGEDB} -1 ${fastq_pair_r1} -2 ${fastq_pair_r2} -U ${fastq_unpair_r1},${fastq_unpair_r2} -S ${metagen_dir}${spec}_ClassificationResult.txt  --report-file ${metagen_dir}${spec}_ClassificationSummary.txt --thread 30"
